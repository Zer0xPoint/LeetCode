...
#  
# 
#  Related Topics Array Two Pointers Binary Search Sorting 👍 2548 👎 77
...
class Solution:
    def successfulPairs(self, spells: List[int], potions: List[int], success: int) -> List[int]:
        potions.sort()
        return [self.countSuccessfulPairs(spell, potions, success) for spell in spells]

    # count the number of successful pairs
    def countSuccessfulPairs(self, spell, potions, success):
